namespace _08._Ranking
{
    ...
    public class StartUp
    {
        ...
        static Dictionary<string, string> ReadContestAndPasswordData()
        {
            ...
            while ((inputLineFromConsole = Console.ReadLine()) != "end of contests")
            {
                string contest = inputLineFromConsole.Split(":").First();
                string password = inputLineFromConsole.Split(":").Last();
        ...
        static SortedDictionary<string, Dictionary<string, int>> GetStudentsScores(Dictionary<string, string> contestsDict)
        {
            ...
            string inputLineFromConsole;
            while ((inputLineFromConsole = Console.ReadLine()) != "end of submissions")
            {
